...
- (void)setupButtons {
    ...
    if (self.keyboardEnabled){
        ...
        [_boldButton.titleLabel setFont:[UIFont fontWithName:kSourceSansProBold size:21]];
        _boldButton.layer.borderColor = [UIColor colorWithWhite:1 alpha:.2].CGColor;
        ...
        [_underlineButton.titleLabel setFont:[UIFont fontWithName:kSourceSansProBold size:21]];
        _underlineButton.layer.borderColor = [UIColor colorWithWhite:1 alpha:.2].CGColor;
...
- (void)textViewDidBeginEditing:(UITextView *)textView {
    NSLog(@"textview did begin editing from XXTextView");
    if ([[NSUserDefaults standardUserDefaults] boolForKey:kDarkBackground]){
        self.keyboardAppearance = UIKeyboardAppearanceDark;
    } else {
        self.keyboardAppearance = UIKeyboardAppearanceDefault;
...
- (void)textViewDidChangeSelection:(UITextView *)textView {    
    ...
    NSLog(@"selected text: %@",_selectedText);
